...
def evaluate(dataloader, encoder, classifier, args, noisy_label, clean_label, i, stat_logs):
    ...
    with torch.no_grad():
        ...
        prediction_knn = temp_fast_weighted_knn_ball( feature_bank, feature_bank, modified_label, args.num_classes, args.k,  radius = args.radius, radaptive=args.radaptive, otsu_split=otsu_split, teto=args.teto, kmin1=args.kmin1, kmin2=args.kmin2 )  # temperature in weighted KNN
