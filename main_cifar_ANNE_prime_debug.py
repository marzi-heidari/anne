...
def evaluate(dataloader, encoder, classifier, args, noisy_label, clean_label, i, stat_logs):
    ...
    with torch.no_grad():
        ...
        prediction_knn, knn_min, knn_max, knn_mean, knn_std = weighted_knn_ball(i, feature_bank, feature_bank, modified_label, args.num_classes,  chunks=100, radius = 0.99, rule="type2", conf=his_score, knnweight=False, radaptive="otsu_rad3", otsu_split=otsu_split, teto=args.teto )  # temperature in weighted KNN
